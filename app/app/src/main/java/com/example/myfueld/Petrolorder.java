...
public class Petrolorder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter <String> myAdapter = new ArrayAdapter<String>(Petrolorder.this,
        ...
        paycash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Petrolorder.this,"Order Placed Successfully",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        payonline.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Petrolorder.this,onlinepayment.class);
